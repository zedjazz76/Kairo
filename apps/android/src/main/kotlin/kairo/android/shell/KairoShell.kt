    ...
    ScreenScaffold(
        ...
        Button(
            ...
            onClick = {
                ...
                scope.launch {
                    answer = activeCopilot.ask(submittedQuestion)
                }
            },
...
private fun SystemsDestination(onBack: () -> Unit) =
    PlaceholderDestination("Systems overview", "Systems", onBack)

@Composable
private fun WorkflowsDestination(onBack: () -> Unit) =
    PlaceholderDestination("Workflows overview", "Workflows", onBack)

@Composable
private fun ProjectsDestination(onBack: () -> Unit) =
    PlaceholderDestination("Projects overview", "Projects", onBack)

@Composable
private fun KnowledgeDestination(onBack: () -> Unit) =
    PlaceholderDestination("Knowledge overview", "Knowledge", onBack)

@Composable
private fun SourcesDestination(onBack: () -> Unit) =
    PlaceholderDestination("Sources overview", "Sources", onBack)

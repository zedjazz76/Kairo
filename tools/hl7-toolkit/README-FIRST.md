...
The `source` folder contains the Phase One tests, product and Phase One designs, and the implementation plan. Open this extracted handoff folder as a Codex project and say: “Continue KAIRO Guardian HL7 Toolkit from the laptop handoff and begin Stage Two.”

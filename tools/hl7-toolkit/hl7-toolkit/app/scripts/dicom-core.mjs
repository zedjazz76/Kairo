const TAGS = {
  ...
  '0020000D': { name: 'Study Instance UID', keyword: 'StudyInstanceUID', vr: 'UI', vm: '1', category: 'Study', definition: 'Unique identifier for the Study.' },
  ...
  '00080061': { name: 'Modalities in Study', keyword: 'ModalitiesInStudy', vr: 'CS', vm: '1-n', category: 'Study', definition: 'Modalities represented by Series in the Study.' },
  '00080090': { name: 'Referring Physician Name', keyword: 'ReferringPhysicianName', vr: 'PN', vm: '1', category: 'Study', definition: 'Name of the patient’s referring physician.' },
  ...
  '00201206': { name: 'Number of Study Related Series', keyword: 'NumberOfStudyRelatedSeries', vr: 'IS', vm: '1', category: 'Study', definition: 'Number of Series related to the Study.' },
  '00201208': { name: 'Number of Study Related Instances', keyword: 'NumberOfStudyRelatedInstances', vr: 'IS', vm: '1', category: 'Study', definition: 'Number of composite object instances related to the Study.' },
